...
fun main() {
    ...
    fun sortRankOfSameType(cards: List<CamelCard>, part1: Boolean): List<CamelCard> {
        ...
        val comparator = object : Comparator<CamelCard> {
            override fun compare(o1: CamelCard, o2: CamelCard): Int {
                for (i in 0..4) {
    ...
    val input = File("_2023/src/main/resources/daySeven.txt").readText(Charsets.UTF_8).split("\n")
